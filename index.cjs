...
var require_ejs = __commonJS({
  "node_modules/ejs/lib/ejs.js"(exports) {
    ...
    exports.resolveInclude = function(name, filename, isDir) {
      ...
      var includePath = resolve4(isDir ? filename : dirname2(filename), name);
    ...
    function getIncludePath(path5, options2) {
      var includePath;
      var filePath;
      ...
      if (match && match.length) {
        ...
        if (Array.isArray(options2.root)) {
          includePath = resolvePaths(path5, options2.root);
        } else {
          includePath = exports.resolveInclude(path5, options2.root || "/", true);
        }
      } else {
        if (options2.filename) {
          filePath = exports.resolveInclude(path5, options2.filename);
        ...
        if (!includePath && typeof options2.includer !== "function") {
          throw new Error('Could not find the include file "' + options2.escapeFunction(path5) + '"');
        }
      }
      return includePath;
    }
    ...
    function includeFile(path5, options2) {
      ...
      if (typeof options2.includer === "function") {
        var includerResult = options2.includer(path5, opts.filename);
        if (includerResult) {
    ...
    Template.prototype = {
      ...
      compile: function() {
        ...
        if (opts.filename && typeof Object.defineProperty === "function") {
          ...
          var basename3 = path4.basename(filename, path4.extname(filename));
          try {
...
async function init() {
  ...
  const isFeatureFlagsUsed = typeof (argv.default ?? argv.ts ?? argv.jsx ?? argv.router) === "boolean";
...
Scaffolding project in ${root}...`);
  ...
  if (needsTypeScript) {
    preOrderDirectoryTraverse(
      ...
      (filepath) => {
        if (filepath.endsWith(".js") && !FILES_TO_FILTER.includes(path3.basename(filepath))) {
